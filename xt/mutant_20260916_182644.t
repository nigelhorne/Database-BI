...
# Source:  # mismatch or a missing-tables failure so the user knows what to do.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  . 'filename — the application auto-detects and uses the first table found.';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  title    => 'Choose a Database',
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  unless _is_safe_url($url);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  my $dir = $file->dirname->to_string;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_1485_2 (MEDIUM) line 1485 in join_tables() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1485_2 line 1485 in join_tables()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1485 in join_tables() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_1612_2 (MEDIUM) line 1612 in combine_tables() ---
# Source:  =head3 EXAMPLE
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1612_2 line 1612 in combine_tables()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1612 in combine_tables() to detect the mutant
    fail('BOOL_NEGATE_1612_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1617_2 (MEDIUM) line 1617 in combine_tables() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1617_2 line 1617 in combine_tables()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1617 in combine_tables() to detect the mutant
    fail('BOOL_NEGATE_1617_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1697_3 (MEDIUM) line 1697 in export_data() ---
# Source:  -> { "saved": "/home/user/exports/report.csv" }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1697_3 line 1697 in export_data()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1697 in export_data() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_1783_2 (MEDIUM) line 1783 in export_write() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1783_2 line 1783 in export_write()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1783 in export_write() to detect the mutant
    fail('BOOL_NEGATE_1783_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1850_3 (MEDIUM) line 1850 in dirs_api() ---
# Source:  -> { "exists": true, "path": "/data/sales.csv", "mtime": 1700000000, "size": 1234 }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1850_3 line 1850 in dirs_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1850 in dirs_api() to detect the mutant
    fail('BOOL_NEGATE_1850_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1859_2 (MEDIUM) line 1859 in stat_api() ---
# Source:  unless (defined $path && length $path) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_1917_3 (MEDIUM) line 1917 in stat_api() ---
# Source:  =head3 EXAMPLE
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1917_3 line 1917 in stat_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1917 in stat_api() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_1964_2 (MEDIUM) line 1964 in upload_file() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1964_2 line 1964 in upload_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
...
# --- SURVIVOR: BOOL_NEGATE_2010_2 (MEDIUM) line 2010 in clear_uploads() ---
# Source:  #          as the X or Y axis; HTML::D3 displays these in the hover tooltip.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2010_2 line 2010 in clear_uploads()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2010 in clear_uploads() to detect the mutant
    fail('BOOL_NEGATE_2010_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2014_2 (MEDIUM) line 2014 in clear_uploads() ---
# Source:  #          no plottable rows exist.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2014_2 line 2014 in clear_uploads()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2014 in clear_uploads() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_2079_2 (MEDIUM) line 2079 in pie_view() ---
# Source:  my $cat_col     = $self->param('cat') // '';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2079_2 line 2079 in pie_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2079 in pie_view() to detect the mutant
    fail('BOOL_NEGATE_2079_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2083_2 (MEDIUM) line 2083 in pie_view() ---
# Source:  my @filter_specs = $self->every_param('f');
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2083_2 line 2083 in pie_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2083 in pie_view() to detect the mutant
    fail('BOOL_NEGATE_2083_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2085_2 (MEDIUM) line 2085 in pie_view() ---
# Source:  return $self->render(text => 'Missing cat or val column parameter', status => 400)
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2085_2 line 2085 in pie_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2085 in pie_view() to detect the mutant
    fail('BOOL_NEGATE_2085_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2102_2 (MEDIUM) line 2102 in pie_view() ---
# Source:  # Detect the currency symbol (e.g. $ £ EUR) from the first non-empty raw
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2102_2 line 2102 in pie_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2102 in pie_view() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_1485_2 line 1485 in join_tables() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_1612_2 line 1612 in combine_tables() ---
# Source:  =head3 EXAMPLE
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1617_2 line 1617 in combine_tables() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_1697_3 line 1697 in export_data() ---
# Source:  -> { "saved": "/home/user/exports/report.csv" }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1783_2 line 1783 in export_write() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_1850_3 line 1850 in dirs_api() ---
# Source:  -> { "exists": true, "path": "/data/sales.csv", "mtime": 1700000000, "size": 1234 }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1917_3 line 1917 in stat_api() ---
# Source:  =head3 EXAMPLE
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1964_2 line 1964 in upload_file() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_2010_2 line 2010 in clear_uploads() ---
# Source:  #          as the X or Y axis; HTML::D3 displays these in the hover tooltip.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2014_2 line 2014 in clear_uploads() ---
# Source:  #          no plottable rows exist.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2079_2 line 2079 in pie_view() ---
# Source:  my $cat_col     = $self->param('cat') // '';
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_2079_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_2083_2 line 2083 in pie_view() ---
# Source:  my @filter_specs = $self->every_param('f');
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_2083_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_2085_2 line 2085 in pie_view() ---
# Source:  return $self->render(text => 'Missing cat or val column parameter', status => 400)
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_2085_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_2102_2 line 2102 in pie_view() ---
# Source:  # Detect the currency symbol (e.g. $ £ EUR) from the first non-empty raw
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_2102_2: add assertion here');
