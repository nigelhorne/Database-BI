...
# Source:  # Reduction: split(/:/, $spec, 3) always produces at least one defined element,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  # constant within a single filter application.
...
# Source:  my ($col, $op, $val) = split /:/, $spec, 3;
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip <= to <
#   Numeric boundary flip <= to >
...
# --- SURVIVOR: BOOL_NEGATE_326_2 (MEDIUM) line 326 in _csv_row() ---
# Source:  sub _csv_row {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_326_2 line 326 in _csv_row()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 326 in _csv_row() to detect the mutant
    fail('BOOL_NEGATE_326_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_385_2 (MEDIUM) line 385 in _list_dir() ---
# Source:  # Entry:   $records is an arrayref of hashrefs; $columns is an arrayref of names.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
...
# Source:  croak "DBI connect failed: $@" if $@;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  ?f=            string   (repeatable) Filter spec: "col:op:val".
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  plus C<source_url> (the original URL) for C<localStorage> tracking.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  404 application/json   { "error": "not found" }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  Renders C<dashboard.html.tt> with the merged/filtered result set.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  l=         string   (required) Left table spec.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  500 application/json   { "error": "..." }  -- write failure
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  let file = dir / strip_path(param('filename')) in
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  concurrent uploads of files with the same name do not collide.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  file   upload   Supported extensions: csv, db, sql, xml, psv.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- LOW HINT: RETURN_UNDEF_326_2 line 326 in _csv_row() ---
# Source:  sub _csv_row {
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
