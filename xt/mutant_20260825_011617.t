...
# --- SURVIVOR: BOOL_NEGATE_170_2 (MEDIUM) line 170 in _open_spec() ---
# Source:  return ($src, $src->table_name) if $src && !$@;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_170_2 line 170 in _open_spec()';
    ...
    # TODO: exercise line 170 in _open_spec() to detect the mutant
    fail('BOOL_NEGATE_170_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_171_2 (MEDIUM) line 171 in _open_spec() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_171_2 line 171 in _open_spec()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 171 in _open_spec() to detect the mutant
    fail('BOOL_NEGATE_171_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_172_2 (MEDIUM) line 172 in _open_spec() ---
# Source:  return ();
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_172_2 line 172 in _open_spec()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 172 in _open_spec() to detect the mutant
    fail('BOOL_NEGATE_172_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_173_2 (MEDIUM) line 173 in _open_spec() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_173_2 line 173 in _open_spec()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 173 in _open_spec() to detect the mutant
    fail('BOOL_NEGATE_173_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_209_2 (MEDIUM) line 209 in _get_columns() ---
# Source:  return ($id, sort keys %all);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: NUM_BOUNDARY_216_50_== (HIGH) line 216 in _get_columns() ---
# Source:  #          Value may contain colons: "col:op:val:with:colons" -- split limit 3
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip != to ==
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_216_50_== line 216 in _get_columns()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 216 in _get_columns() to detect the mutant
    fail('NUM_BOUNDARY_216_50_==: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_217_50_!= (HIGH) line 217 in _get_columns() ---
# Source:  #          puts everything after the second colon into $val.
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip == to !=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_217_50_!= line 217 in _get_columns()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 217 in _get_columns() to detect the mutant
    fail('NUM_BOUNDARY_217_50_!=: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_218_29_> (HIGH) line 218 in _get_columns() ---
# Source:  #          Unknown operators fall through to 1 (all rows pass) so new operators
# Hint:    Likely missing edge-case test (boundary value)
...
#   Numeric boundary flip < to >=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_218_29_> line 218 in _get_columns()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 218 in _get_columns() to detect the mutant
    fail('NUM_BOUNDARY_218_29_>: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_219_29_< (HIGH) line 219 in _get_columns() ---
# Source:  #          added in future do not break existing callers.
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip <= to <
#   Numeric boundary flip <= to >
#   Numeric boundary flip <= to >=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_219_29_< line 219 in _get_columns()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 219 in _get_columns() to detect the mutant
    fail('NUM_BOUNDARY_219_29_<: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_220_29_< (HIGH) line 220 in _get_columns() ---
# Source:  # Entry:   $records is an arrayref of hashrefs; $spec is a colon-delimited string.
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip > to <
#   Numeric boundary flip > to >=
#   Numeric boundary flip > to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_220_29_< line 220 in _get_columns()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 220 in _get_columns() to detect the mutant
    fail('NUM_BOUNDARY_220_29_<: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_221_29_> (HIGH) line 221 in _get_columns() ---
# Source:  # Exit:    Returns filtered arrayref (same reference if spec is invalid/unparseable).
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip >= to >
#   Numeric boundary flip >= to <
#   Numeric boundary flip >= to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_221_29_> line 221 in _get_columns()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 221 in _get_columns() to detect the mutant
    fail('NUM_BOUNDARY_221_29_>: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_326_2 (MEDIUM) line 326 in _left_join() ---
# Source:  $row{ $_->[1] } = $right_row->{ $_->[0] } for @rcols;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_326_2 line 326 in _left_join()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 326 in _left_join() to detect the mutant
    fail('BOOL_NEGATE_326_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_385_2 (MEDIUM) line 385 in _list_dir() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_385_2 line 385 in _list_dir()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 385 in _list_dir() to detect the mutant
    fail('COND_INV_385_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_396_2 (MEDIUM) line 396 in _list_dir() ---
# Source:  #          The temporary file is created, written, read, and then unlinked in
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_396_2 line 396 in _list_dir()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 396 in _list_dir() to detect the mutant
    fail('BOOL_NEGATE_396_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_569_3 (MEDIUM) line 569 in index() ---
# Source:  my ($platform, $language) = $self->_resolve_template;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_569_3 line 569 in index()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 569 in index() to detect the mutant
    fail('BOOL_NEGATE_569_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_575_3 (MEDIUM) line 575 in index() ---
# Source:  tables   => $self->_scan_data_dir,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_575_3 line 575 in index()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 575 in index() to detect the mutant
    fail('BOOL_NEGATE_575_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_652_2 (MEDIUM) line 652 in view() ---
# Source:  available_tables => $self->_scan_data_dir,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_652_2 line 652 in view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 652 in view() to detect the mutant
    fail('BOOL_NEGATE_652_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_740_2 (MEDIUM) line 740 in browse() ---
# Source:  handler      => 'tt',
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_740_2 line 740 in browse()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 740 in browse() to detect the mutant
    fail('BOOL_NEGATE_740_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_743_2 (MEDIUM) line 743 in browse() ---
# Source:  current_path => $dir->to_string,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_743_2 line 743 in browse()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 743 in browse() to detect the mutant
    fail('BOOL_NEGATE_743_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_756_3 (MEDIUM) line 756 in browse() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_756_3 line 756 in browse()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 756 in browse() to detect the mutant
    fail('BOOL_NEGATE_756_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_847_2 (MEDIUM) line 847 in open_file() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_847_2 line 847 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 847 in open_file() to detect the mutant
    fail('BOOL_NEGATE_847_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_848_2 (MEDIUM) line 848 in open_file() ---
# Source:  C<GET /import> -- Fetch a remote HTML page, extract the first (or selected)
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_848_2 line 848 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 848 in open_file() to detect the mutant
    fail('BOOL_NEGATE_848_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_852_2 (MEDIUM) line 852 in open_file() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_852_2 line 852 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 852 in open_file() to detect the mutant
    fail('BOOL_NEGATE_852_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_855_2 (MEDIUM) line 855 in open_file() ---
# Source:  ?url=          string   Required.  Full http:// or https:// URL of the page
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_855_2 line 855 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 855 in open_file() to detect the mutant
    fail('BOOL_NEGATE_855_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_929_3 (MEDIUM) line 929 in import_url() ---
# Source:  available_tables => $self->_scan_data_dir,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_929_3 line 929 in import_url()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 929 in import_url() to detect the mutant
    fail('BOOL_NEGATE_929_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_935_3 (MEDIUM) line 935 in import_url() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_935_3 line 935 in import_url()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 935 in import_url() to detect the mutant
    fail('COND_INV_935_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_942_2 (MEDIUM) line 942 in import_url() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_942_2 line 942 in import_url()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 942 in import_url() to detect the mutant
    fail('BOOL_NEGATE_942_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1007_2 (MEDIUM) line 1007 in columns_api() ---
# Source:  C<GET /join> -- Perform one or more left joins and render the merged table.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1007_2 line 1007 in columns_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1007 in columns_api() to detect the mutant
    fail('BOOL_NEGATE_1007_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1011_3 (MEDIUM) line 1011 in columns_api() ---
# Source:  =head4 INPUT
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1011_3 line 1011 in columns_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1011 in columns_api() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_1120_2 (MEDIUM) line 1120 in join_tables() ---
# Source:  title            => $title,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1120_2 line 1120 in join_tables()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1120 in join_tables() to detect the mutant
    fail('BOOL_NEGATE_1120_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1177_3 (MEDIUM) line 1177 in export_data() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1177_3 line 1177 in export_data()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1177 in export_data() to detect the mutant
    fail('BOOL_NEGATE_1177_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1189_3 (MEDIUM) line 1189 in export_data() ---
# Source:  =head4 INPUT
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1189_3 line 1189 in export_data()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1189 in export_data() to detect the mutant
    fail('BOOL_NEGATE_1189_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1196_2 (MEDIUM) line 1196 in export_data() ---
# Source:  format: C<.csv> -> RFC 4180 CSV; C<.sql> -> SQLite.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1196_2 line 1196 in export_data()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1196 in export_data() to detect the mutant
    fail('BOOL_NEGATE_1196_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_1201_3 (MEDIUM) line 1201 in export_data() ---
# Source:  404 application/json   { "error": "..." }  -- bad dir or table not found
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1201_3 line 1201 in export_data()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1201 in export_data() to detect the mutant
    fail('COND_INV_1201_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1212_2 (MEDIUM) line 1212 in export_data() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1212_2 line 1212 in export_data()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1212 in export_data() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_1337_2 (MEDIUM) line 1337 in dirs_api() ---
# Source:  =head3 API SPECIFICATION
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1337_2 line 1337 in dirs_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1337 in dirs_api() to detect the mutant
    fail('BOOL_NEGATE_1337_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1395_3 (MEDIUM) line 1395 in stat_api() ---
# Source:  $self->render(json => {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_1403_3 (MEDIUM) line 1403 in stat_api() ---
# Source:  =head2 upload_file
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1403_3 line 1403 in stat_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1403 in stat_api() to detect the mutant
    fail('BOOL_NEGATE_1403_3: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_170_2 line 170 in _open_spec() ---
# Source:  return ($src, $src->table_name) if $src && !$@;
...
# --- LOW HINT: RETURN_UNDEF_171_2 line 171 in _open_spec() ---
# Source:  }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_172_2 line 172 in _open_spec() ---
# Source:  return ();
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_173_2 line 173 in _open_spec() ---
# Source:  }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_326_2 line 326 in _left_join() ---
# Source:  $row{ $_->[1] } = $right_row->{ $_->[0] } for @rcols;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_396_2 line 396 in _list_dir() ---
# Source:  #          The temporary file is created, written, read, and then unlinked in
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_569_3 line 569 in index() ---
# Source:  my ($platform, $language) = $self->_resolve_template;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_575_3 line 575 in index() ---
# Source:  tables   => $self->_scan_data_dir,
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_652_2 line 652 in view() ---
# Source:  available_tables => $self->_scan_data_dir,
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_740_2 line 740 in browse() ---
# Source:  handler      => 'tt',
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_743_2 line 743 in browse() ---
# Source:  current_path => $dir->to_string,
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_756_3 line 756 in browse() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_847_2 line 847 in open_file() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_848_2 line 848 in open_file() ---
# Source:  C<GET /import> -- Fetch a remote HTML page, extract the first (or selected)
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_852_2 line 852 in open_file() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_855_2 line 855 in open_file() ---
# Source:  ?url=          string   Required.  Full http:// or https:// URL of the page
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_929_3 line 929 in import_url() ---
# Source:  available_tables => $self->_scan_data_dir,
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_942_2 line 942 in import_url() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_1007_2 line 1007 in columns_api() ---
# Source:  C<GET /join> -- Perform one or more left joins and render the merged table.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1011_3 line 1011 in columns_api() ---
# Source:  =head4 INPUT
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1120_2 line 1120 in join_tables() ---
# Source:  title            => $title,
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1177_3 line 1177 in export_data() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_1189_3 line 1189 in export_data() ---
# Source:  =head4 INPUT
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1196_2 line 1196 in export_data() ---
# Source:  format: C<.csv> -> RFC 4180 CSV; C<.sql> -> SQLite.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1212_2 line 1212 in export_data() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_1337_2 line 1337 in dirs_api() ---
# Source:  =head3 API SPECIFICATION
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1403_3 line 1403 in stat_api() ---
# Source:  =head2 upload_file
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
