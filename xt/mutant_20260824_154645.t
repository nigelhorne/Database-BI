...
# --- SURVIVOR: COND_INV_19_5 (MEDIUM) line 19 in index() ---
# Source:  if (-d $dir_path) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_19_5 line 19 in index()';
    ...
    # TODO: exercise line 19 in index() to detect the mutant
    fail('COND_INV_19_5: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_47_9 (MEDIUM) line 47 in view() ---
# Source:  return $self->reply->not_found;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_47_9 line 47 in view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 47 in view() to detect the mutant
    fail('BOOL_NEGATE_47_9: replace with real assertion');
}

# --- SURVIVOR: COND_INV_52_5 (MEDIUM) line 52 in view() ---
# Source:  if ($@) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_52_5 line 52 in view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 52 in view() to detect the mutant
    fail('COND_INV_52_5: replace with real assertion');
}

# --- SURVIVOR: COND_INV_69_5 (MEDIUM) line 69 in view() ---
# Source:  if ($source->columns) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_69_5 line 69 in view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 69 in view() to detect the mutant
    fail('COND_INV_69_5: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_98_9 (MEDIUM) line 98 in browse() ---
# Source:  return $self->reply->not_found;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_98_9 line 98 in browse()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 98 in browse() to detect the mutant
    fail('BOOL_NEGATE_98_9: replace with real assertion');
}

# --- SURVIVOR: COND_INV_102_5 (MEDIUM) line 102 in browse() ---
# Source:  if (opendir my $dh, $dir->to_string) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_102_5 line 102 in browse()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 102 in browse() to detect the mutant
    fail('COND_INV_102_5: replace with real assertion');
}

# --- SURVIVOR: COND_INV_107_13 (MEDIUM) line 107 in browse() ---
# Source:  if (-d $f) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_107_13 line 107 in browse()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 107 in browse() to detect the mutant
    fail('COND_INV_107_13: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_167_9 (MEDIUM) line 167 in open_file() ---
# Source:  return $self->reply->not_found;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_167_9 line 167 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 167 in open_file() to detect the mutant
    fail('BOOL_NEGATE_167_9: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_172_9 (MEDIUM) line 172 in open_file() ---
# Source:  return $self->reply->not_found;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_172_9 line 172 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 172 in open_file() to detect the mutant
    fail('BOOL_NEGATE_172_9: replace with real assertion');
}

# --- SURVIVOR: COND_INV_183_5 (MEDIUM) line 183 in open_file() ---
# Source:  if ($@) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_183_5 line 183 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 183 in open_file() to detect the mutant
    fail('COND_INV_183_5: replace with real assertion');
}

# --- SURVIVOR: COND_INV_198_5 (MEDIUM) line 198 in open_file() ---
# Source:  if ($source->columns) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_198_5 line 198 in open_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 198 in open_file() to detect the mutant
    fail('COND_INV_198_5: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_47_9 line 47 in view() ---
# Source:  return $self->reply->not_found;
...
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_47_9: add assertion here');

# --- LOW HINT: RETURN_UNDEF_98_9 line 98 in browse() ---
# Source:  return $self->reply->not_found;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_98_9: add assertion here');

# --- LOW HINT: RETURN_UNDEF_167_9 line 167 in open_file() ---
# Source:  return $self->reply->not_found;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_167_9: add assertion here');

# --- LOW HINT: RETURN_UNDEF_172_9 line 172 in open_file() ---
# Source:  return $self->reply->not_found;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
# e.g. my $result = Database::BI::Controller::Dashboard->method(...);
# ok($result, 'RETURN_UNDEF_172_9: add assertion here');
