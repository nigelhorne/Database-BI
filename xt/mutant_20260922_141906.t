...
# Source:  pre  self.stash('table') =~ TABLE_NAME_RE
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  let sources  = [left] ++ map(open_spec, param_list('c')) in
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  post if format = 'sqlite' then render_sqlite(recs, cols)
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_1735_3 (MEDIUM) line 1735 in export_data() ---
# Source:  pre  is_dir(dir) /\ ext(file) in {csv, sql}
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1735_3 line 1735 in export_data()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1735 in export_data() to detect the mutant
    fail('BOOL_NEGATE_1735_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1748_3 (MEDIUM) line 1748 in export_write() ---
# Source:  sub export_write ($self) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  json   => { error => $self->_i18n('error_dir_not_found', $dir) },
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_1821_2 (MEDIUM) line 1821 in export_write() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1821_2 line 1821 in export_write()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1821 in export_write() to detect the mutant
    fail('BOOL_NEGATE_1821_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1888_3 (MEDIUM) line 1888 in dirs_api() ---
# Source:  pre  path /= undef
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1888_3 line 1888 in dirs_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1888 in dirs_api() to detect the mutant
    fail('BOOL_NEGATE_1888_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1897_2 (MEDIUM) line 1897 in dirs_api() ---
# Source:  -> { "exists": true, "path": "/data/sales.csv", "mtime": 1700000000, "size": 1234 }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1897_2 line 1897 in dirs_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1897 in dirs_api() to detect the mutant
    fail('BOOL_NEGATE_1897_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1955_3 (MEDIUM) line 1955 in stat_api() ---
# Source:  =head3 FORMAL SPECIFICATION
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1955_3 line 1955 in stat_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1955 in stat_api() to detect the mutant
    fail('BOOL_NEGATE_1955_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1967_3 (MEDIUM) line 1967 in stat_api() ---
# Source:  -> { "url": "/open?path=%2F...%2Fsales.csv", "path": "/.../.uploads/abc123/sales.csv" }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1967_3 line 1967 in stat_api()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 1967 in stat_api() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_2002_2 (MEDIUM) line 2002 in upload_file() ---
# Source:  # Store uploads in <app_home>/.uploads/<random_subdir>/<original_filename>.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2002_2 line 2002 in upload_file()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2002 in upload_file() to detect the mutant
    fail('BOOL_NEGATE_2002_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2048_2 (MEDIUM) line 2048 in clear_uploads() ---
# Source:  # graph_view
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2048_2 line 2048 in clear_uploads()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2048 in clear_uploads() to detect the mutant
    fail('BOOL_NEGATE_2048_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2052_2 (MEDIUM) line 2052 in clear_uploads() ---
# Source:  #            x=<column>  -- X-axis column name
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2052_2 line 2052 in clear_uploads()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2052 in clear_uploads() to detect the mutant
    fail('BOOL_NEGATE_2052_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2056_2 (MEDIUM) line 2056 in clear_uploads() ---
# Source:  #          Each data point carries an "extra" hash of every column not used
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2056_2 line 2056 in clear_uploads()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2056 in clear_uploads() to detect the mutant
    fail('BOOL_NEGATE_2056_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2058_2 (MEDIUM) line 2058 in clear_uploads() ---
# Source:  #          A "Reset zoom" button appears after the user brushes to zoom in.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2058_2 line 2058 in clear_uploads()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2058 in clear_uploads() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_2113_2 (MEDIUM) line 2113 in graph_view() ---
# Source:  handler          => 'tt',
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2113_2 line 2113 in graph_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2113 in graph_view() to detect the mutant
    fail('BOOL_NEGATE_2113_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2117_2 (MEDIUM) line 2117 in graph_view() ---
# Source:  graph_html       => $snippet->{html},
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2117_2 line 2117 in graph_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2117 in graph_view() to detect the mutant
    fail('BOOL_NEGATE_2117_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2121_2 (MEDIUM) line 2121 in graph_view() ---
# Source:  ref_min_y        => $min_y,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2121_2 line 2121 in graph_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2121 in graph_view() to detect the mutant
    fail('BOOL_NEGATE_2121_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2127_2 (MEDIUM) line 2127 in graph_view() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_2127_2 line 2127 in graph_view()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 2127 in graph_view() to detect the mutant
    fail('BOOL_NEGATE_2127_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_2158_2 (MEDIUM) line 2158 in pie_view() ---
# Source:  # Not used in count mode because counts are always plain integers.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- LOW HINT: RETURN_UNDEF_1735_3 line 1735 in export_data() ---
# Source:  pre  is_dir(dir) /\ ext(file) in {csv, sql}
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1821_2 line 1821 in export_write() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
...
# --- LOW HINT: RETURN_UNDEF_1888_3 line 1888 in dirs_api() ---
# Source:  pre  path /= undef
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1897_2 line 1897 in dirs_api() ---
# Source:  -> { "exists": true, "path": "/data/sales.csv", "mtime": 1700000000, "size": 1234 }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1955_3 line 1955 in stat_api() ---
# Source:  =head3 FORMAL SPECIFICATION
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_1967_3 line 1967 in stat_api() ---
# Source:  -> { "url": "/open?path=%2F...%2Fsales.csv", "path": "/.../.uploads/abc123/sales.csv" }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2002_2 line 2002 in upload_file() ---
# Source:  # Store uploads in <app_home>/.uploads/<random_subdir>/<original_filename>.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2048_2 line 2048 in clear_uploads() ---
# Source:  # graph_view
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2052_2 line 2052 in clear_uploads() ---
# Source:  #            x=<column>  -- X-axis column name
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2056_2 line 2056 in clear_uploads() ---
# Source:  #          Each data point carries an "extra" hash of every column not used
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2058_2 line 2058 in clear_uploads() ---
# Source:  #          A "Reset zoom" button appears after the user brushes to zoom in.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2113_2 line 2113 in graph_view() ---
# Source:  handler          => 'tt',
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2117_2 line 2117 in graph_view() ---
# Source:  graph_html       => $snippet->{html},
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2121_2 line 2121 in graph_view() ---
# Source:  ref_min_y        => $min_y,
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_2127_2 line 2127 in graph_view() ---
# Source:  }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
