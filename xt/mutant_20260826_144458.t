...
# --- SURVIVOR: BOOL_NEGATE_437_2 (MEDIUM) line 437 in _left_join() ---
# Source:  #          original order), then each subsequent source contributes any new
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_437_2 line 437 in _left_join()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 437 in _left_join() to detect the mutant
    fail('BOOL_NEGATE_437_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_506_3 (MEDIUM) line 506 in _build_export_url() ---
# Source:  #          (names starting with ".") are excluded.  Entries are sorted
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_506_3 line 506 in _build_export_url()';
    # NOTE: Database::BI::Controller::Dashboard has no constructor — call class methods directly.
    # e.g. my $result = Database::BI::Controller::Dashboard->method(...);
    # TODO: exercise line 506 in _build_export_url() to detect the mutant
...
# Source:  next unless $right_set{$right_key};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  -> unified view: all cat and dog rows; Species/Name/Color/Breed/Eye Color
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  C<POST /export> -- Write the current logical view to a chosen filesystem path.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  dir=       string   Target directory (must exist; resolved via realpath).
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  # Strip any path separators the browser might include.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- LOW HINT: RETURN_UNDEF_437_2 line 437 in _left_join() ---
# Source:  #          original order), then each subsequent source contributes any new
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
